...
public:
    ...
    void on_order_cancel_rejected(const std::string &custom_order_id, const std::string &reason) override {
        std::cout << "[Test] Order Cancel Rejected: " << custom_order_id << " " << reason << std::endl;
    }
